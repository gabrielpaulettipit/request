...
@Component
public class RequestOraclePersonNotes {
	...
	@Transactional
	@RabbitListener(queues = "PersonNotes")
	public void recebeMensagem(RequestQueue requestQueue) {
//		System.out.println(requestQueue.user() +" - "+ requestQueue.password() +" - "+ requestQueue.endpoint());
...
//		System.out.println("print 3");
		...
		for (PersonNotesRecord gradeRecord : resp.getBody().items()) {
			personNotesRepository.save(new PersonNotesEntity(gradeRecord));
		}
